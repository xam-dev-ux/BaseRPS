...
export function useCommitReveal({ matchId, currentRound }: UseCommitRevealProps) {
  ...
  const commit = useCallback(
    ...
    [matchId, currentRound, isCommitting, addSalt, commitChoice, setMyChoice, updatePhase, removeSalt]
  );
  ...
  }, [matchId, currentRound, isRevealing, getSalt, revealChoice, updatePhase, removeSalt]);
